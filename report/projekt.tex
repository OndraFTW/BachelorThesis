...
\projectinfo{
  ...
  %Autor
  author={Ondøej ©lampa},   %jmeno prijmeni autora
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={Rust, OpenMP, paralelizace, paralelní programování, konvoluce.}, %klicova slova v ceskem jazyce
  keywords.en={Rust, OpenMP, paralelization, parallel programing, convolution.}, %klicova slova v anglickem jazyce
  %Abstract
  abstract.cs={Tato práce se zabývá paralelizací v~jazyce Rust. Cílem této práce je zhodnotit výkon a pou¾itelnost jazyka Rust pro tvorbu paralelních aplikací ve srovnání s~ji¾ pou¾ívanou alternativou - OpenMP. Toto porovnání bylo provedeno na výpoètu n-rozmìrné konvoluce. V~závìru se nachází zhodnocení výsledkù a návrhy pro jejich dal¹í vyu¾ití.}, % abstrakt v ceskem jazyce
  ...
  %Prohlaseni
  declaration={Prohla¹uji, ¾e jsem tuto bakaláøskou práci vypracoval samostatnì pod vedením pana Ing. Jozefa Kobrtka.},
  %Podekovani (nepovinne)
  acknowledgment={Chtìl bych podìkovat panu Ing. Jozefu Kobrtkovi za pøínosné a pravidelné konzultace, odborné rady a bezproblémovou komunikaci.} % nepovinne
}
